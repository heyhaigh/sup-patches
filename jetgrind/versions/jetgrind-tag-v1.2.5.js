...
const BACKGROUNDS = {
  shibuya: { name: "🌃 Shibuya", prompt: "Jet Set Radio Dreamcast game screenshot, FLAT FRONTAL VIEW straight-on perspective, Tokyo street wall covered in neon signs and Japanese billboards, flat solid color fills NO gradients, thick black outlines on everything, muted grey-brown base with bright neon pink blue green accents, low-poly angular geometric shapes, dark pavement foreground, simple stylized 2000s video game aesthetic, cel-shaded" },
  garage: { name: "🏠 Garage", prompt: "Jet Set Radio Dreamcast game screenshot, FLAT FRONTAL VIEW straight-on perspective, indoor garage wall with dark tile grid floor, flat solid color fills NO gradients, thick black outlines, muted olive green and dark grey walls, industrial speakers and equipment along edges, simple geometric shapes, harsh flat lighting, cel-shaded 2000s video game aesthetic" },
  shutter: { name: "🚪 Shutter", prompt: "Jet Set Radio Dreamcast game screenshot, FLAT FRONTAL VIEW straight-on perspective, metal roll-up shutter door filling frame, corrugated metal texture, flat solid color fills NO gradients, thick black outlines, muted grey and rust brown tones, Japanese storefront signs above, simple geometric shapes, cel-shaded 2000s video game aesthetic" },
  street: { name: "🛣️ Street", prompt: "Jet Set Radio Dreamcast game screenshot, FLAT FRONTAL VIEW straight-on perspective, Tokyo alley wall with storefronts, flat solid color fills NO gradients, thick black outlines on every edge, muted brown grey concrete with neon sign accents, dark asphalt ground, low-poly angular architecture, cel-shaded 2000s video game aesthetic" },
  train: { name: "🚃 Train Yard", prompt: "Jet Set Radio Dreamcast game screenshot, FLAT FRONTAL VIEW straight-on perspective, subway train car side panel filling frame, flat solid color fills NO gradients, thick black outlines, silver grey metal with colored stripe accents, simple geometric rectangles, industrial train yard, cel-shaded 2000s video game aesthetic" },
  rooftop: { name: "🌆 Rooftop", prompt: "Jet Set Radio Dreamcast game screenshot, FLAT FRONTAL VIEW straight-on perspective, rooftop wall with water tanks and AC units, flat solid color fills NO gradients, thick black outlines, muted grey green concrete, simple geometric boxy shapes, Tokyo skyline silhouette behind, cel-shaded 2000s video game aesthetic" },
  highway: { name: "🛤️ Highway", prompt: "Jet Set Radio Dreamcast game screenshot, FLAT FRONTAL VIEW straight-on perspective, concrete highway barrier wall, flat solid color fills NO gradients, thick black outlines, muted grey brown tones, road signs and guardrails, simple angular geometric shapes, dark asphalt ground, cel-shaded 2000s video game aesthetic" },
  sewers: { name: "🚰 Sewers", prompt: "Jet Set Radio Dreamcast game screenshot, FLAT FRONTAL VIEW straight-on perspective, underground sewer tunnel wall with pipes and grates, flat solid color fills NO gradients, thick black outlines, dark olive green and grey tones, grid tile floor pattern, industrial pipes, cel-shaded 2000s video game aesthetic" },
  plaza: { name: "🏬 Plaza", prompt: "Jet Set Radio Dreamcast game screenshot, FLAT FRONTAL VIEW straight-on perspective, shopping plaza wall with Japanese storefronts, flat solid color fills NO gradients, thick black outlines, muted grey base with bright neon signage, tile floor grid pattern, simple geometric architecture, cel-shaded 2000s video game aesthetic" },
  tower: { name: "📡 Tower", prompt: "Jet Set Radio Dreamcast game screenshot, FLAT FRONTAL VIEW straight-on perspective, Tokyo Tower metal lattice structure, flat solid color fills NO gradients, thick black outlines, orange and grey geometric framework, simple angular shapes against sky, cel-shaded 2000s video game aesthetic" }
};
