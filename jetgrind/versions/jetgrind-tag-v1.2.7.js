...
const BACKGROUNDS = {
  shibuya: { name: "🌃 Shibuya", prompt: "Sega Dreamcast Jet Set Radio screenshot, EXTREMELY LOW POLY simplified 3D, frontal view, Tokyo neon district wall, very few large polygons, chunky blocky geometry, bright pink and blue neon signs on grey concrete, thick black outlines, minimal detail, 1999 video game graphics, cel-shaded toon render" },
  garage: { name: "🏠 Garage", prompt: "Sega Dreamcast Jet Set Radio screenshot, EXTREMELY LOW POLY simplified 3D, frontal view, indoor basement with checkered floor, very few large polygons, chunky boxy shapes, WARM ORANGE and BROWN tones with yellow lighting, large speaker boxes, thick black outlines, minimal detail, 1999 video game graphics, cel-shaded toon render" },
  shutter: { name: "🚪 Shutter", prompt: "Sega Dreamcast Jet Set Radio screenshot, EXTREMELY LOW POLY simplified 3D, frontal view, metal roll-up shutter door, very few large polygons, simple corrugated texture, SILVER and BLUE metallic tones, Japanese shop signs, thick black outlines, minimal detail, 1999 video game graphics, cel-shaded toon render" },
  street: { name: "🛣️ Street", prompt: "Sega Dreamcast Jet Set Radio screenshot, EXTREMELY LOW POLY simplified 3D, frontal view, Tokyo back alley wall, very few large polygons, chunky brick shapes, WARM BROWN and TAN concrete with red vending machines, thick black outlines, minimal detail, 1999 video game graphics, cel-shaded toon render" },
  train: { name: "🚃 Train Yard", prompt: "Sega Dreamcast Jet Set Radio screenshot, EXTREMELY LOW POLY simplified 3D, frontal view, subway train car side, very few large polygons, simple rectangular panels, SILVER train with BRIGHT COLORED stripe accents, thick black outlines, minimal detail, 1999 video game graphics, cel-shaded toon render" },
  rooftop: { name: "🌆 Rooftop", prompt: "Sega Dreamcast Jet Set Radio screenshot, EXTREMELY LOW POLY simplified 3D, frontal view, Tokyo rooftop scene, very few large polygons, boxy water tanks, LIGHT GREY and WHITE concrete with BLUE sky, city silhouette, thick black outlines, minimal detail, 1999 video game graphics, cel-shaded toon render" },
  highway: { name: "🛤️ Highway", prompt: "Sega Dreamcast Jet Set Radio screenshot, EXTREMELY LOW POLY simplified 3D, frontal view, highway overpass barrier, very few large polygons, simple concrete wall, GREY and DARK BLUE tones with yellow road signs, thick black outlines, minimal detail, 1999 video game graphics, cel-shaded toon render" },
  tunnel: { name: "🚇 Tunnel", prompt: "Sega Dreamcast Jet Set Radio screenshot, EXTREMELY LOW POLY simplified 3D, frontal view, underground subway tunnel, very few large polygons, curved tunnel walls, DARK PURPLE and MAGENTA lighting with tiled walls, thick black outlines, minimal detail, 1999 video game graphics, cel-shaded toon render" },
  plaza: { name: "🏬 Plaza", prompt: "Sega Dreamcast Jet Set Radio screenshot, EXTREMELY LOW POLY simplified 3D, frontal view, shopping district wall, very few large polygons, simple storefront shapes, BRIGHT MULTICOLOR neon signs on beige walls, thick black outlines, minimal detail, 1999 video game graphics, cel-shaded toon render" },
  tower: { name: "📡 Tower", prompt: "Sega Dreamcast Jet Set Radio screenshot, EXTREMELY LOW POLY simplified 3D, frontal view, Tokyo Tower lattice, very few large polygons, geometric metal framework, BRIGHT ORANGE and WHITE structure against blue sky, thick black outlines, minimal detail, 1999 video game graphics, cel-shaded toon render" }
};
