...
const BACKGROUNDS = {
  shibuya: { name: "🌃 Shibuya", prompt: "Sega Dreamcast Jet Set Radio in-game screenshot, 3D rendered low-poly Tokyo street scene with cel-shading post-process, frontal view, polygonal buildings with visible facets, neon Japanese billboards and signs, thick black toon outlines on 3D geometry, muted concrete textures with bright neon accents, early 2000s video game graphics, real-time 3D render with toon shader" },
  garage: { name: "🏠 Garage", prompt: "Sega Dreamcast Jet Set Radio in-game screenshot, 3D rendered low-poly indoor garage with cel-shading post-process, frontal view, polygonal walls and tiled floor with visible geometry, industrial equipment and speakers, thick black toon outlines on 3D surfaces, dark green and grey textures, early 2000s video game graphics, real-time 3D render with toon shader" },
  shutter: { name: "🚪 Shutter", prompt: "Sega Dreamcast Jet Set Radio in-game screenshot, 3D rendered low-poly metal shutter door with cel-shading post-process, frontal view, corrugated metal 3D texture, Japanese storefront geometry above, thick black toon outlines on surfaces, grey and brown urban textures, early 2000s video game graphics, real-time 3D render with toon shader" },
  street: { name: "🛣️ Street", prompt: "Sega Dreamcast Jet Set Radio in-game screenshot, 3D rendered low-poly Tokyo alley with cel-shading post-process, frontal view, polygonal storefronts and walls with visible facets, dark asphalt ground plane, thick black toon outlines on 3D geometry, neon sign accents, early 2000s video game graphics, real-time 3D render with toon shader" },
  train: { name: "🚃 Train Yard", prompt: "Sega Dreamcast Jet Set Radio in-game screenshot, 3D rendered low-poly subway train car with cel-shading post-process, frontal view of train side panel, polygonal metal surfaces with colored stripes, thick black toon outlines on 3D geometry, industrial rail yard setting, early 2000s video game graphics, real-time 3D render with toon shader" },
  rooftop: { name: "🌆 Rooftop", prompt: "Sega Dreamcast Jet Set Radio in-game screenshot, 3D rendered low-poly Tokyo rooftop with cel-shading post-process, frontal view, polygonal water tanks and AC units with visible geometry, city skyline backdrop, thick black toon outlines on 3D surfaces, concrete textures, early 2000s video game graphics, real-time 3D render with toon shader" },
  highway: { name: "🛤️ Highway", prompt: "Sega Dreamcast Jet Set Radio in-game screenshot, 3D rendered low-poly highway overpass with cel-shading post-process, frontal view, polygonal concrete barriers and road signs, thick black toon outlines on 3D geometry, grey asphalt and guardrails, early 2000s video game graphics, real-time 3D render with toon shader" },
  sewers: { name: "🚰 Sewers", prompt: "Sega Dreamcast Jet Set Radio in-game screenshot, 3D rendered low-poly sewer tunnel with cel-shading post-process, frontal view, polygonal pipes and grated floors with visible geometry, thick black toon outlines on 3D surfaces, dark green industrial textures, early 2000s video game graphics, real-time 3D render with toon shader" },
  plaza: { name: "🏬 Plaza", prompt: "Sega Dreamcast Jet Set Radio in-game screenshot, 3D rendered low-poly shopping plaza with cel-shading post-process, frontal view, polygonal Japanese storefronts with visible facets, tiled floor geometry, thick black toon outlines on 3D surfaces, neon signage accents, early 2000s video game graphics, real-time 3D render with toon shader" },
  tower: { name: "📡 Tower", prompt: "Sega Dreamcast Jet Set Radio in-game screenshot, 3D rendered low-poly Tokyo Tower with cel-shading post-process, frontal view, polygonal metal lattice framework with visible geometry, thick black toon outlines on 3D structure, orange and grey colors, early 2000s video game graphics, real-time 3D render with toon shader" }
};
