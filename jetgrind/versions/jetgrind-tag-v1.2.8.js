...
const BACKGROUNDS = {
  shibuya: { name: "🌃 Shibuya", prompt: "Dreamcast era 3D video game screenshot, frontal view, Tokyo nightlife district, LOW RESOLUTION grungy realistic textures on simple 3D geometry, blurry pixelated texture quality, neon Japanese signs and billboards, black outlines on geometry edges only, baked lighting with pre-rendered shadows, muted concrete with bright neon accents, late 1990s real-time 3D graphics" },
  garage: { name: "🏠 Garage", prompt: "Dreamcast era 3D video game screenshot, frontal view, underground garage with red metal pillars, LOW RESOLUTION grungy realistic textures on simple 3D geometry, blurry pixelated texture quality, industrial warehouse with oil barrels and crates, black outlines on geometry edges only, baked lighting, warm orange and brown rust tones, late 1990s real-time 3D graphics" },
  shutter: { name: "🚪 Shutter", prompt: "Dreamcast era 3D video game screenshot, frontal view, Japanese storefront with metal shutter, LOW RESOLUTION grungy realistic textures on simple 3D geometry, blurry pixelated texture quality, corrugated metal door texture, Japanese shop signs above, black outlines on geometry edges only, baked lighting, grey and brown urban tones, late 1990s real-time 3D graphics" },
  street: { name: "🛣️ Street", prompt: "Dreamcast era 3D video game screenshot, frontal view, Tokyo back alley with brick wall, LOW RESOLUTION grungy realistic textures on simple 3D geometry, blurry pixelated texture quality, checkered brown brick pattern, Japanese vending machines, black outlines on geometry edges only, baked lighting, warm tan and brown tones, late 1990s real-time 3D graphics" },
  train: { name: "🚃 Train Yard", prompt: "Dreamcast era 3D video game screenshot, frontal view, silver subway train car side, LOW RESOLUTION grungy realistic textures on simple 3D geometry, blurry pixelated texture quality, metallic train panels with colored stripe, black outlines on geometry edges only, baked lighting, grey silver with accent colors, late 1990s real-time 3D graphics" },
  rooftop: { name: "🌆 Rooftop", prompt: "Dreamcast era 3D video game screenshot, frontal view, Tokyo rooftop with water tanks, LOW RESOLUTION grungy realistic textures on simple 3D geometry, blurry pixelated texture quality, concrete and metal structures, black outlines on geometry edges only, baked lighting, grey concrete against blue sky, late 1990s real-time 3D graphics" },
  highway: { name: "🛤️ Highway", prompt: "Dreamcast era 3D video game screenshot, frontal view, highway underpass with yellow-black hazard stripes, LOW RESOLUTION grungy realistic textures on simple 3D geometry, blurry pixelated texture quality, concrete pillars and barriers, black outlines on geometry edges only, baked lighting, grey with yellow caution markings, late 1990s real-time 3D graphics" },
  fence: { name: "🌳 Park", prompt: "Dreamcast era 3D video game screenshot, frontal view, urban park with green chain-link fence, LOW RESOLUTION grungy realistic textures on simple 3D geometry, blurry pixelated texture quality, metal fence grid pattern, trees and buildings behind, black outlines on geometry edges only, baked lighting, green fence on tan ground, late 1990s real-time 3D graphics" },
  plaza: { name: "🏬 Plaza", prompt: "Dreamcast era 3D video game screenshot, frontal view, Japanese shopping street with storefronts, LOW RESOLUTION grungy realistic textures on simple 3D geometry, blurry pixelated texture quality, shop awnings and signs, black outlines on geometry edges only, baked lighting, colorful signs on beige buildings, late 1990s real-time 3D graphics" },
  factory: { name: "🏭 Factory", prompt: "Dreamcast era 3D video game screenshot, frontal view, industrial factory with red steel beams, LOW RESOLUTION grungy realistic textures on simple 3D geometry, blurry pixelated texture quality, metal framework and windows, black outlines on geometry edges only, baked lighting, red metal on grey concrete, late 1990s real-time 3D graphics" }
};
...
function renderTagPortfolioView() {
  ...
  const pageSize = 6; // Show 6 thumbnails per page
...
async function main() {
  ...
  if (action === "generateBackground") {
    ...
    const editPrompt = `Add a stylized background behind this graffiti tag. Replace the white/transparent background with: ${bg.prompt}. Keep the graffiti text exactly as it appears, only change the background. Wide panoramic format.`;
