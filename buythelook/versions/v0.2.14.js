...
function getSmartRetailer(category, query) {
  switch (category) {
    case "costume":
      return {
        url: `https://www.etsy.com/search?q=${encodeURIComponent(query + " costume")}`,
        retailer: "Etsy"
      };
    case "fanMerch":
      return {
    ...
    case "athletic":
      return {
        url: `https://www.amazon.com/s?k=${encodeURIComponent(query)}&rh=n:7141123011`,
        retailer: "Amazon Sports"
      };
    case "formal":
      return {
        url: `https://www.nordstrom.com/sr?keyword=${encodeURIComponent(query)}`,
        retailer: "Nordstrom"
      };
    case "outdoor":
      return {
    ...
    case "vintage":
      return {
        url: `https://poshmark.com/search?q=${encodeURIComponent(query)}`,
        retailer: "Poshmark"
      };
    case "jewelry":
      return {
        url: `https://www.etsy.com/search?q=${encodeURIComponent(query + " jewelry")}`,
        retailer: "Etsy"
      };
    case "accessories":
      return {
