    ...
    items: {
      ...
      items: {
        ...
        properties: {
          ...
          searchQuery: {
            type: "string",
            description: "Search query for shopping. For luxury brands: use generic terms ('green cashmere sweater'). For budget/generic items: use character references ('Link tunic costume', 'Hylian shield backpack') since fan merch exists on Amazon."
          }
        }
      }
    },
...
const analysisPrompt = [
  ...
  "",
  "For searchQuery field - use TWO different strategies:",
  "- LUXURY BRANDS (Gucci, Prada, etc): generic retail terms ('green cashmere sweater', 'brown leather boots')",
  "- BUDGET/GENERIC items: character-referential terms work great! ('Link costume tunic', 'Hylian shield backpack', 'Shrek ears headband') - Amazon has tons of fan merch."
].join("\n");
