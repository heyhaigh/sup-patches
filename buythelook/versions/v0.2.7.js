    ...
    items: {
      ...
      items: {
        ...
        properties: {
          ...
          searchQuery: {
            type: "string",
            description: "CRITICAL: A realistic product search query using ONLY real retail terms. Include: color + material + product type. Example: 'green wool sweater', 'brown leather combat boots', 'blue crossbody bag'. NEVER use fantasy/fictional terms like 'Hyrule', 'elven', 'adventure'. Keep it simple and shoppable."
          }
        }
      }
    },
...
const analysisPrompt = [
  ...
  "",
  "CRITICAL for searchQuery field:",
  "- Use ONLY real retail/shopping terms that would work on Amazon or Google Shopping",
  "- Format: [color] [material] [product type] - e.g., 'green wool sweater', 'brown leather boots'",
  "- NEVER use fantasy terms, character names, or fictional references",
  "- BAD: 'Hyrule adventure hat', 'elven tunic', 'Link cosplay boots'",
  "- GOOD: 'green pointed hat', 'green wool tunic', 'brown leather knee boots'",
  "- The meme can reference the character, but searchQuery must be real shopping terms"
].join("\n");
...
const defaultsPrompt = [
  ...
  "Remember: searchQuery must use real retail terms, not fantasy/character names."
].join("\n");
