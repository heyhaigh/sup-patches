    ...
    items: {
      ...
      items: {
        ...
        properties: {
          ...
          productName: {
            type: "string",
            description: "Real menswear product name (e.g., 'Henley Shirt', 'Slim Joggers', 'Chelsea Boots', 'Bomber Jacket'). NO costume terms like 'tunic' or 'tights'."
          },
          price: {
            type: "string",
          ...
          searchQuery: {
            type: "string",
            description: "Retail search query using real product terms (e.g., 'white slim joggers', 'green henley shirt', 'brown chelsea boots'). Fan merch can use character refs ('Zelda shield')."
          }
        }
      }
    },
...
const analysisPrompt = [
  ...
  "- CAREFULLY identify EACH item the subject wears (top, pants, boots, hat, belt, etc.)",
  "- Match EXACT colors (white pants = white, green shirt = green)",
  "",
  "CRITICAL - Use REAL retail product names (not costume terms):",
  ...
  "",
  "Rules:",
  "- Pick 4-6 MENSWEAR items matching the subject's outfit.",
  "- 60% luxury (Gucci, Prada, Balenciaga). 40% budget (Nike, H&M, Target) or unbranded.",
  "- Prices: Luxury $500-$5000. Budget $15-$150. Unbranded $5-$50.",
  "- searchQuery: use retail terms ('white slim joggers' not 'white tights').",
  "- Fan merch/props can use character refs ('Zelda shield backpack').",
  "- Set category: clothing, shoes, accessories, costume, fanMerch, athletic, formal, outdoor."
].join("\n");
