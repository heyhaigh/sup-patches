...
const PRODUCT_CATEGORIES = {
  ...
  outdoor: ["hiking", "camping", "outdoor", "waterproof", "rain", "snow", "boots", "jacket", "fleece", "parka"],
...
// Detect category from product name and search query
function detectCategory(productName, searchQuery) {
...
function generateBuyLinks(schemaData) {
  ...
  for (const item of schemaData.items) {
    ...
    const category = detectCategory(item.productName, baseQuery);
