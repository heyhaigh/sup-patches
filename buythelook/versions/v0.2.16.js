...
const analysisPrompt = [
  "You create 'Steal His/Her/Their Look' fashion memes matching subjects to fashion items by color/features.",
  "",
  "Rules:",
  "- Subject can be anything: characters, celebrities, animals, objects, memes, etc.",
  "- Pick 4-6 MENSWEAR items that match the subject's colors/features.",
  "- 60% luxury brands (Gucci, Prada, Balenciaga, Louis Vuitton, Burberry, Versace).",
  "- 40% budget brands (Nike, Adidas, H&M, Uniqlo, Target, Amazon, Carhartt, Levi's) or unbranded.",
  "- Use realistic prices. Luxury: $500-$5000. Budget: $15-$150. Unbranded: $5-$50.",
  "- Include one absurd/humorous item match.",
  "- For searchQuery: branded items use generic terms ('green wool sweater'). Costume/fan merch can use character refs ('Zelda shield backpack').",
  "- Set category field: clothing, shoes, accessories, costume, fanMerch, athletic, formal, or outdoor."
].join("\n");
