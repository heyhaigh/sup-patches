    ...
    items: {
      ...
      items: {
        ...
        properties: {
          ...
          productName: {
            type: "string",
            description: "Menswear product (e.g., 'Cashmere Sweater', 'Leather Belt', 'Oxford Shoes', 'Bomber Jacket')."
          },
          price: {
            type: "string",
          ...
          searchQuery: {
            type: "string",
            description: "Retail search terms. Branded items: generic ('green cashmere sweater'). Fan merch/costume: character refs OK ('Zelda shield replica')."
          }
        }
      }
    },
...
const analysisPrompt = [
  "You create 'Steal His/Her/Their Look' fashion memes matching subjects to fashion items.",
  "",
  "CRITICAL - Accurate matching:",
  "- CAREFULLY identify EACH distinct item the subject wears/has (tunic, tights, boots, hat, belt, etc.)",
  "- Match the EXACT color of each item (white tights = white, not green)",
  "- Example for Link: green tunic, white tights, brown boots, green hat, brown belt, shield, sword",
  "",
  "Rules:",
  "- Pick 4-6 MENSWEAR items that match the subject's ACTUAL outfit colors.",
  "- 60% luxury brands (Gucci, Prada, Balenciaga, Louis Vuitton, Burberry, Versace).",
  "- 40% budget brands (Nike, Adidas, H&M, Uniqlo, Target, Amazon, Carhartt) or unbranded.",
  "- Prices: Luxury $500-$5000. Budget $15-$150. Unbranded $5-$50.",
  "- Include one absurd/humorous item.",
  "- searchQuery: branded = generic terms ('white athletic tights'). Fan merch = character refs ('Zelda shield').",
  "- Set category: clothing, shoes, accessories, costume, fanMerch, athletic, formal, or outdoor."
].join("\n");

const defaultsPrompt = [
  "Create a 'Steal The Look' meme for a random iconic subject.",
